...
VM_PREFIX = VBltDspMod
# Module prefix (from --prefix)
VM_MODPREFIX = VBltDspMod
...
sim_dsptst0.o: sim_dsptst0.cpp
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST) -c -o $@ $<

### Link rules... (from --exe)
VBltDspMod: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a
