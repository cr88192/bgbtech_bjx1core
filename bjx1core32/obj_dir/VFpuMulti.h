...
#ifndef _VFpuMulti_H_
#define _VFpuMulti_H_

#include "verilated.h"
class VFpuMulti__Syms;
...
VL_MODULE(VFpuMulti) {
  public:
    ...
    // INTERNAL VARIABLES
    // Internals; generally not touched by application code
    VFpuMulti__Syms*	__VlSymsp;		// Symbol table
    ...
    // CONSTRUCTORS
  private:
    VFpuMulti& operator= (const VFpuMulti&);	///< Copying not allowed
    VFpuMulti(const VFpuMulti&);	///< Copying not allowed
  public:
    /// Construct the model; called by application code
    /// The special name  may be used to make a wrapper with a
    /// single model invisible WRT DPI scope names.
    VFpuMulti(const char* name="TOP");
    ...
    // INTERNAL METHODS
  private:
    static void _eval_initial_loop(VFpuMulti__Syms* __restrict vlSymsp);
  public:
    void __Vconfigure(VFpuMulti__Syms* symsp, bool first);
  private:
    static QData	_change_request(VFpuMulti__Syms* __restrict vlSymsp);
  public:
    static void	_combo__TOP__11(VFpuMulti__Syms* __restrict vlSymsp);
    static void	_combo__TOP__3(VFpuMulti__Syms* __restrict vlSymsp);
    static void	_combo__TOP__5(VFpuMulti__Syms* __restrict vlSymsp);
    static void	_combo__TOP__7(VFpuMulti__Syms* __restrict vlSymsp);
    static void	_combo__TOP__9(VFpuMulti__Syms* __restrict vlSymsp);
  private:
    void	_configure_coverage(VFpuMulti__Syms* __restrict vlSymsp, bool first);
    void	_ctor_var_reset();
  public:
    static void	_eval(VFpuMulti__Syms* __restrict vlSymsp);
    static void	_eval_initial(VFpuMulti__Syms* __restrict vlSymsp);
    static void	_eval_settle(VFpuMulti__Syms* __restrict vlSymsp);
    static void	_initial__TOP__2(VFpuMulti__Syms* __restrict vlSymsp);
    static void	_settle__TOP__1(VFpuMulti__Syms* __restrict vlSymsp);
    static void	_settle__TOP__10(VFpuMulti__Syms* __restrict vlSymsp);
    static void	_settle__TOP__4(VFpuMulti__Syms* __restrict vlSymsp);
    static void	_settle__TOP__6(VFpuMulti__Syms* __restrict vlSymsp);
    static void	_settle__TOP__8(VFpuMulti__Syms* __restrict vlSymsp);
} VL_ATTR_ALIGNED(128);
